...
const menuItems = [
    ...
    { icon: PlusCircle, label: "Add Document", href: "/dashboard/add" },
    { icon: History, label: "Activity Log", href: "/dashboard/activity" },
                ...
                {menuItems.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <item.icon className={cn("h-5 w-5", isActive ? "text-[#A8BBA3]" : "text-neutral-500 group-hover:text-neutral-900 dark:text-neutral-400 dark:group-hover:text-white")} />
